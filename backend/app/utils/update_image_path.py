...
DB_PATH = PROJECT_ROOT / "backend"/"app"/"database" / "products.db"
JSON_PATH = PROJECT_ROOT / "output" / "image_metadata.json"
import sqlite3
import json
...
# CONFIG
# -------------------------------
# DB_PATH = r"C:\Users\abhinav.pandey\Desktop\hp-ai-deck-generator\backend\app\database\products.db"   # path to your SQL database
# JSON_PATH = r"C:\Users\abhinav.pandey\Desktop\hp-ai-deck-generator\output\image_metadata.json"    # path to your JSON file
